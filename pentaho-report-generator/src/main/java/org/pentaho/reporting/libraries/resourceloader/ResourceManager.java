...
public final class ResourceManager {
  ...
  public Resource createDirectly( final Object keyValue, final Class target )
    ...
    System.out.println("Created key: " + key.getIdentifierAsString());
  ...
  public synchronized ResourceBundleData loadResourceBundle( final ResourceKey key ) throws ResourceLoadingException {
	System.out.println("Entering loadResourceBundle(" + key.getIdentifierAsString() + ")");
    ...
    System.out.println("Class of backend is: " + backend.getClass().getName());
  ...
  public ResourceData load( final ResourceKey key ) throws ResourceLoadingException {
    ...
    System.out.println("Testing is bundle.");
    if ( bundle != null ) {
      System.out.println("Verified is bundle, returning bundle.");
      logger.debug( "Loaded bundle for key " + key );
      return bundle;
    }
    final ResourceKey parent = key.getParent();
    System.out.println("Testing has parent.");
    if ( parent != null ) {
      System.out.println("Verified has parent.");
  ...
  public Resource create( final ResourceKey key, final ResourceKey context, final Class[] target )
    ...
    System.out.println("loadedData for key " + key.getIdentifierAsString() + " is of type: " + loadedData.getClass().getName());
    if ( loadedData instanceof ResourceBundleData ) {
      System.out.println("loadedData is a Resource Bundle for " + key.getIdentifierAsString() + ".");
      ...
      System.out.println("loadedData is NOT a Resource Bundle for " + key.getIdentifierAsString() + ".");
