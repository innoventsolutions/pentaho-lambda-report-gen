...
/*
 * Modified to move the engine initialization so that it happen only once in a higher level
 * controlling class.
 */
...
public abstract class AbstractReportGenerator
{
   ...
   */
  public abstract MasterReport getReportDefinition() throws ResourceException;
 ...
 * @throws ResourceException 
  ...
  public void generateReport(final OutputType outputType, File outputFile)
      throws IllegalArgumentException, IOException, ReportProcessingException, ResourceException
  {
    if (outputFile == null)
    {
  ...
  public void generateReport(final OutputType outputType, OutputStream outputStream)
      throws IllegalArgumentException, ReportProcessingException, ResourceException
  {
    if (outputStream == null)
    {
